...
def play(word):
    ...
    while again.lower() == 'д':
        ...
        print(display_hangman(6), "У Вас есть шесть попыток)")
        word_completion = '_' * len(word)  # строка, содержащая символы _ на каждую букву задуманного слова
        print("Загаданное слово: ", word_completion)
        while True:
            letter = input("Введите букву кириллицы, которая как Вам кажется есть в слове: ").upper()
            if is_valid(letter) == False:
                print('А может быть все-таки введем букву кириллицы')
                continue
            else:
                guessed_letters.append(letter)

            if guessed_letters.count(letter) > 1:
                print("Эту букву вы уже указывали. Введите другую.")
                total += 0
            ...
            if total>0:
                ...
                tries -=1
                print(display_hangman(tries),"У Вас осталось", tries, "попыток)")


            if word_completion.isalpha() and tries>0:
                print("Поздравляем, вы угадали слово! Вы победили!")
                guessed_words.append(word_completion)
                break
            elif tries<=0:
                print("Игра окончена! Загаданное слово: ", word)
                break
        again = input("Хотите сыграть еще один раз?(д=да, н=нет):")
        tries = 6
        word = get_word()
        if again.lower() == "н":
            print("Возвращайся как захочешь сыграть!")
            break
